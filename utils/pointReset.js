...
function startPointResetCycle() {
    resetPoints().finally(() => {
        // Jadwalkan eksekusi berikutnya setelah interval
        setTimeout(startPointResetCycle, POINTS_RESET_INTERVAL);
    });
}
...
module.exports = { 
    startPointReset: startPointResetCycle,
    manualReset
};