        ...
        try {
            const inviteEmbed = new EmbedBuilder()
                ...
                .addFields(
                    {
                        name: 'Invite Link',
                        value: `[Click Here](https://discord.com/oauth2/authorize?client_id=1393135995494596618&permissions=8&scope=bot%20applications.commands)`,
                        inline: true
                    },
                    {
                        name: 'Support Server',
                        value: '[Join Here](https://discord.gg/DanXGuild)',
                        inline: true
                    }
                )
