...
const { Client, GatewayIntentBits, Partials, REST, EmbedBuilder } = require("discord.js");
...
const guildMemberAddHandler = require('./events/task/guildMemberAdd');
const guildMemberRemoveHandler = require('./events/task/guildMemberRemove');
...
class DanXBot {
    ...
    initializeEvents() {
        ...
        this.client.on('guildMemberAdd', (member) => {
            guildMemberAddHandler.run(member, this.client);
        });
        // Leave message handler
        this.client.on('guildMemberRemove', (member) => {
            guildMemberRemoveHandler.run(member, this.client);
        });
